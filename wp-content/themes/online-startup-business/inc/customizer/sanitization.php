 ...
 */
function onlinestartupbusiness_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function onlinestartupbusiness_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function onlinestartupbusiness_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function onlinestartupbusiness_sanitize_float( $input ) {
 ...
 */
function onlinestartupbusiness_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function onlinestartupbusiness_sanitize_html( $html ) {
 ...
 */
function onlinestartupbusiness_sanitize_image( $image, $setting ) {
 ...
 */
function onlinestartupbusiness_sanitize_nohtml( $nohtml ) {
 ...
 */
function onlinestartupbusiness_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function onlinestartupbusiness_sanitize_range_value( $number, $setting ) {
 ...
 */
function onlinestartupbusiness_sanitize_select( $input, $setting ) {
 ...
 */
function onlinestartupbusiness_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function onlinestartupbusiness_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function onlinestartupbusiness_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
