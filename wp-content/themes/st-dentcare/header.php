...
<body <?php body_class(); ?>>
	...
	<a class="skip-link screen-reader-text" href="#skip-link-target"><?php _e( 'Skip to content', 'st-dentcare' ); ?></a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo text-center text-md-left mb-3 mb-md-0">
					...
					?>
						<h1 class="site-title">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr_e( 'Home', 'st-dentcare' ); ?>" rel="home">
				...
				<div class="col-lg-6 col-md-5 align-self-center text-center text-lg-right">
					<button class="menu-toggle my-2 py-2 px-3" aria-controls="top-menu" aria-expanded="false" type="button">
						<span aria-hidden="true"><?php esc_html_e( '☰', 'st-dentcare' ); ?></span>
					</button>
